  ...
  return (
    <div className='bg-[#1b1c24] h-screen flex items-center justify-center flex-col gap-10'>
      <div className="flex flex-col gap-10 w-[80vh] md:w-max">
          ...
          <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
            ...
            <div className="w-full">
              <Input placeholder="FullName"
                type="text" value={"GianSiccardi"}
                className="rounded-lg p-6 bg-[#2c2e3b] border-none" />
            </div>
            <div className="w-full">
              <Input placeholder="PhoneNumber"
                type="text" value={"2612589941"}
                className="rounded-lg p-6 bg-[#2c2e3b] border-none" />
            </div>
        ...
        <div className="w-full">
          <Button className="h-16 w-full bg-purple-700 hover:bg-purple-900 transition-all duration-300" onClick={(updateUser)}>
            Guardar Cambios
          </Button>
